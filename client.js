...
addSelectedMessage(message.text, message.user.name);
                ...
                {addMessage(message.text, message.user.name);}                 
            ...
            // for (user in allUsers.entries){021
...
var name;
  ...
  function hideContent(){document.getElementsByClassName('container main-section')[0].style.visibility = 'hidden';}
 
function userRegistered(){  document.getElementsByClassName('container main-section')[0].style.visibility = 'visible';
 name = document.getElementById("username").value
nick = document.getElementById("pass").value
if (name ==="" || nick === "")
{document.getElementsByClassName('container main-section')[0].style.visibility = 'hidden';}else {
